...
Vaša shema »Sestavljanje« in »Sodba« se tu neposredno ujema z Lockom: v poglavju o kompleksnih idejah Locke pove, da um operira z idejami na več osnovnih načinov—združuje (kompozicija), primerja (relacije), abstrahira (splošne ideje). »Sodba« pa v Lockovem registru pomeni prehod od samih idej k trditvam: resnica in neresnica sta strogo lastnosti _propozicij_ (sodb), ne golih idej; ideje dobijo oznako »resnične« ali »lažne« šele, ko jih um _referira_ na nekaj zunaj njih in predpostavi skladnost.

Posebej pomembno (tudi za vaš del »pozitivne/negativne predstave«) je Lockovo opažanje, da lahko tudi »privacije« (odsotnosti) povzročijo _pozitivne ideje_ v umu: tema je doživeta ideja (pozitivna v zavesti), četudi je njen vzrok odsotnost svetlobe; podobno mir (rest) nasproti gibanju. To pokaže, da Locke dosledno ločuje idejo _kot doživeto vsebino_ od vprašanja, kakšna je _zunanja_ narava njene vzročnosti—kar je že zametek njegovega razlikovanja med videzom in telesno-konstitutivnimi lastnostmi, ki vzrokujejo videze.

V tem kontekstu je primerjava z Descartesom konceptualno uporabna, če jo postavimo natančno. Descartes svojo metafiziko realnosti pogosto izrazi prek triade **substanca–atribut–modus**: substanca je tisto, kar obstaja (v osnovnem smislu) samo po sebi; atribut je bistvena lastnost substance; modusi pa so načini, kako se atribut konkretno kaže. Pri dveh glavnih substancah—miselni in razsežni—je atribut miselne substance mišljenje, atribut telesne pa razsežnost; modusi so npr. dvom, hotenje (pri mišljenju) in gibanje, položaj, oblika (pri razsežnosti). Vendar Descartes hkrati zagovarja delitev idej na prirojene, pridobljene in narejene; idejo Boga npr. označi kot »prirojeno v meni« (innate), in v razpravah o idejah nastopa terminološki okvir, ki ga Locke zavrne. Locke si zato »enostavne ideje« lahko predstavljamo kot opisno-epistemološki analogon Descartesovih »osnovnih« vsebin, vendar brez metafizične zaveze prirojenosti: pri Locku niso vtisnjene od rojstva, ampak vstopajo po čutnosti/refleksiji.